...
clear all
close all
datadir = 'F:\matlab_allcodes_delete\matlab\bin\projectdeep\codes\codes\cifar100_run\Run_CIFAR_100\45_degrees'; 
downloadCIFAR100Data(datadir);
[XTrain1,YTrain1,XValidation1,YValidation1] = loadCIFAR100Data(datadir);
